...
static const TypeInfo fdt_qom_aliases[] = {
    ...
    {   .name = "xlnx,zynqmp-dummy-periph", .parent = "zynqmp.dummy-periph" },
    ...
    {   .name = "xlnx,zynqmp-ddr-phy",      .parent = "xlnx.zynqmp-ddr-phy" },
    {   .name = "xlnx,zynqmp-ddrc-2.0",     .parent = "xlnx.zynqmp-ddrc"    },
};
